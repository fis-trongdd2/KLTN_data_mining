...
public class TopicModel {
	static String trainFile = "input/data.txt";
	...
	public static void main(String[] args) throws Exception {
		...
		FileOutputStream outmodel = new FileOutputStream("model.25.obj");
		ObjectOutputStream omodel = new ObjectOutputStream(outmodel);
		omodel.writeObject(model);
		omodel.close();
