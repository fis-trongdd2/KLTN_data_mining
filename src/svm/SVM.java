...
public class SVM {
	...
	public double[] evaluate_all_instances(String Filename1, svm_model model1, int record_size) {
		// read data from file
		// read the data from file and put it in the train module
		...
		for (int i = 0; i < record_size; i++) {
			...
			double v = evaluate_single_instance(tmp_indexes, tmp_values, model1);
			result[i] = v;
		}
		return result;
	}
	...
	public static void main(String[] args) {
		...
		svm_model model2 = t123.svmTrain("input/sonar_scale_train.txt", 208, 60);

		t123.evaluate_all_instances("input/sonar_test.txt", model2, 10);
